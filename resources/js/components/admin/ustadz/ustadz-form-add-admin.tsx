...
import { UstadzRequestType } from '@/types/admin/ustadz';
import { useForm } from '@inertiajs/react';
import { Plus } from 'lucide-react';
import { FormEventHandler } from 'react';

export default function UstadzFormAddAdmin() {
    const { data, setData, post } = useForm<UstadzRequestType>();
            ...
            <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[625px]">
                <form onSubmit={submit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Silakan isi formulir di bawah ini untuk menambahkan Ustadz baru ke dalam sistem pondok pesantren. Pastikan seluruh data
