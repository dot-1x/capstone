...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('izins', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('target_santri_id');   // santri
            $table->unsignedBigInteger('opened_by')->nullable(); // ustadz
            ...
            $table->foreign('target_santri_id')->references('id')->on('users');
